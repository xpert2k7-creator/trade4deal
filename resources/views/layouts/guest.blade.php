...
<head>
    ...
    <title>{{ config('app.name', 'Trade4Deal') }}</title>
...
<body>
    <div id="pageLoader"><div class="t4d-spinner"></div></div>
    <script>
        setTimeout(function () {
    ...
    <div class="min-vh-100 d-flex flex-column align-items-center justify-content-center py-5 px-3">
        <a href="{{ route('home') }}" class="d-inline-block mb-4 text-decoration-none">
            <x-brand-logo :height="88" />
        </a>

        <div class="card card-t4d w-100" style="max-width: 480px;">
        ...
        <p class="text-muted small mt-4 mb-0">
            <a href="{{ route('home') }}" class="text-decoration-none text-muted">← Back to marketplace</a>
        </p>
    </div>
