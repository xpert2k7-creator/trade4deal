...
<head>
    ...
    <title>Lead Update — Trade4Deal</title>
</head>
    ...
    <tr>
        <td align="center">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #E2E8F0;">
                <tr>
                    <td style="background:linear-gradient(135deg,#0B3A6E 0%,#082F58 100%);padding:28px 32px;text-align:center;">
                ...
                <tr>
                    <td style="padding:32px;">
                        <div style="display:inline-block;background:rgba(100,116,139,0.15);color:#475569;font-size:12px;font-weight:700;padding:6px 12px;border-radius:999px;margin-bottom:16px;">NOT PUBLISHED</div>
                        <h1 style="margin:0 0 12px;font-size:22px;line-height:1.3;color:#0B3A6E;">Update on your submission</h1>
                        <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#334155;">
                            Hello {{ $lead->contact_name }},
                        </p>
                        <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:#334155;">
                            Thank you for your interest in Trade4Deal. After review, we are unable to publish the lead below on the marketplace at this time. You are welcome to submit a new inquiry with additional details.
                        </p>
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#F7F8FA;border-radius:12px;border:1px solid #E2E8F0;margin-bottom:24px;">
                            <tr>
                                <td style="padding:16px 18px;">
                                    <p style="margin:0 0 8px;font-size:12px;text-transform:uppercase;letter-spacing:0.06em;color:#64748B;font-weight:700;">Submission</p>
                                    <p style="margin:0 0 6px;font-size:14px;color:#0F172A;"><strong>Company:</strong> {{ $lead->company_name }}</p>
                                    <p style="margin:0;font-size:14px;color:#0F172A;"><strong>Interest:</strong> {{ $lead->product_interest }}</p>
                                </td>
                            </tr>
                        </table>
                        <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 auto 8px;">
                            <tr>
                                <td style="border-radius:10px;background:#0B3A6E;">
                                    <a href="{{ $homeUrl }}" style="display:inline-block;padding:14px 28px;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;">Visit Trade4Deal</a>
                                </td>
                            </tr>
                        </table>
                    </td>
